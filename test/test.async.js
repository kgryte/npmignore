...
describe( 'async', function tests() {
	...
	it( 'should create a .npmignore file in a specified directory', function test() {
		var dirpath;
	...
	it( 'should create a .npmignore file in a specified directory without requiring a callback', function test() {
		var dirpath;
	...
	it( 'should create a .npmignore file using a specified template', function test() {
		var dirpath;
