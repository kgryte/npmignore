...
*	Asynchronously creates a .npmignore file.
*
* @param {String} dest - .npmignore destination directory
* @param {Object} [opts] - function options
* @param {String} [opts.template="default"] - .npmignore template to use
* @param {Function} [clbk] - callback to invoke upon attempting to create a .npmignore file
*/
function cp() {
	var args = arguments,
		nargs = args.length,
	...
	fpath = path.join( __dirname, tmpl, 'npmignore' );
	dpath = path.join( dest, '.npmignore' );
